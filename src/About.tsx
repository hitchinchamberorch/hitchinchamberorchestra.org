    ...
    <div className="container">
      ...
      >
        ...
        <p>
          ...
          professional instrumental teachers, and a core of freelance musicians
          who lead the sections.
        </p>
        ...
        <p>
          ...
          outlook wherein commitment and determination to succeed are as valued
          attributes as advanced skill and musicianship. We seek and expect
          challenge! The pay-off comes with the warm satisfaction of playing a
          part in performances of a high standard and from which our audiences
        ...
        <p>
          ...
          Tilehouse Baptist Church in Hitchin, on Friday evenings between 7.30pm
          and 10pm at more or less fortnightly intervals. (The local
          ‘Highlander’ pub rounds off the evening for those who can stay.) This
          pattern of commitment has proved popular whilst also affording players
          more time to assimilate the music alongside busy work schedules and
          home lives.
        </p>
        <p>
        ...
        <p>
          ...
          selling tickets to their friends, families and colleagues so that our
          concerts are well attended and subscription rates can stay low
        ...
        <p>
          ...
          HCO doesn't have full time first and second violins and does not seat
          players hierarchically; our practice reflects the belief that it is
          important to have a backbone of more experienced players throughout
          all the sections. The orchestra's size varies from concert to concert
          to reflect the repertoire and the capacity of the particular concert
          venue, therefore players are not necessarily invited to play for every
          event.
        </p>
        <p>
      ...
      >
        ...
        <ul>
          <li>
            Nick Evans-Pughe, Vanessa Gaidoni, Helen Lord, Jan Tothill, Catriona
            Bevan
          </li>
        </ul>
        <p>
        ...
        <p>
          <strong>
            The committee acknowledges the contributions all members and friends
            make
          </strong>{' '}
          to the smooth running of the orchestra in many ways, such as helping
          with setting up and resetting, transport, selling tickets, welcoming,
          bowing music, offering lifts, stewarding, taking photographs and so on
          and extends its thanks and appreciation to all.
        </p>
      </article>
    </div>
  </div>
